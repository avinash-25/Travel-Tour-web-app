...
public class Home extends JFrame{
    ...
    public Home(String username) {
        super("Travel and Tour Application");
	...
	NewLabel.setBounds(0, 0, 1950, 1000); 
        ...
        JLabel l1 = new JLabel("Travel and Tour Application");
	...
	m6.add(mi14);
        ...
        JMenuItem mi16 = new JMenuItem("WEATHER");
        m6.add(mi16);
        ...
        mi16.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent ae){
                try{
                    Runtime.getRuntime().exec("msnweather.exe");
                }catch(Exception e){ }
            }
	});
